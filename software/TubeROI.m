...
% 
    ...
    methods
        function obj = TubeROI(tracks,fringe)
            if(~(numel(tracks)==2))
        ...
        function [idx,dist]=mapPosition(obj,positionMatrixCell)
            ...
            for fIdx=mappedFrame
                ...
                [idx{fIdx},dist{fIdx}]=mapPointsTo1DManifold(positionMatrixCell{fIdx}',manifoldAtT,obj.fringe,'distType','normalDistPseudOptimized');
