function plot_fig3_draft_v8()
%PLOT_FIG3_DRAFT_V8  Same layout as v7, but driven by the corrected MC
%  results (Munkres-optimal + dummy-extended Chenouard alpha/beta/JSC,
%  matching Chenouard et al. 2014 exactly). Linking accuracy, completeness,
%  purity, merges, orientation error are unchanged from v7. Chenouard
%  alpha and JSC win-fractions shifted (alpha 35% -> 50%, JSC 43% -> 52%).
%
...
outPath = fullfile(outDir, 'fig3_draft_v8.png');
